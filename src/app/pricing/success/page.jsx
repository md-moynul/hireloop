...
export default async function Success({ searchParams }) {
  ...
  const { status, customer_details, metadata,amount_total, currency, id } = session;
          ...
          <section className="bg-neutral-950 border border-neutral-850 rounded-2xl p-5 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="text-neutral-300 font-medium truncate max-w-50 sm:max-w-65">
                  {customerEmail}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center text-xs pt-1.5 border-t border-neutral-900">
                ...
                <span className="text-[11px] text-neutral-400 font-mono tracking-tight bg-neutral-900 px-2 py-1 rounded border border-neutral-800 flex items-center gap-1.5 max-w-45 sm:max-w-60 truncate">
                  {id.substring(0, 16)}...
                </span>
              </div>
            </div>
